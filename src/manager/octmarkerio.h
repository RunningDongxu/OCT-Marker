...
public:
	...
	static OctMarkerFileformat getFormatFromExtension(const std::filesystem::path& markersPath);
	...
	bool loadMarkers(const std::filesystem::path& markersPath    , OctMarkerFileformat format);
